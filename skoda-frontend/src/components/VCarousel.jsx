                            ...
                            <div className="slider flex flex-col gap-8 mt-10 relative">
                                ...
                                {images.map((e, i) => (
                                    <div className="mt-5" key={i}>
                                        <img className="small-image w-100" src={'http://127.0.0.1:8000/media/' + e} alt="small" />
                                    </div>
                                ))}
                                <div
                        ...
                        <Col sm={5} xs={10}>
                            <div className="flex gap-6 my-5">
                                ...
                                <div className="image" style={{height:'400px'}}>
                                    <img className="big-image img-fluid h-100"  src={'http://127.0.0.1:8000/media/' + images[current]} alt="sofa" />
                                </div>
                            </div>
                        </Col>
